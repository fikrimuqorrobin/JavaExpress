...
<!--            <form:label path="tipePaket">Tipe Paket</form:label>
            ...
            Tipe Paket <form:radiobutton path="tipePaket" value="Paket"/>Paket 
                 <form:radiobutton path="tipePaket" value="Dokumen"/> Dokumen <br/>
            ...
            Asuransi <form:radiobutton path="asuransi" value="Y"/>Ya 
                 <form:radiobutton path="asuransi" value="T"/> Tidak <br/>
...
<!--                    <form:label path="status">Status</form:label>
                    <form:input path="status" value="${status.idStatus}" placeholder="koko"/><br/>-->
