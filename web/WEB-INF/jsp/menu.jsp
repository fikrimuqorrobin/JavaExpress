...
<ul>
    ...
    <li><a href="${pageContext.request.contextPath}/home/tracking">Tracking No Resi Pengiriman</a></li>
...
<ul>
    <li><a href="${pageContext.request.contextPath}/home">Home</a></li>
    <li><a href="${pageContext.request.contextPath}/input/tracking"> Tracking Pengiriman</a>></li>>
